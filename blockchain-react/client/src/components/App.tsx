...
const App: React.FC = () => {
  ...
  const handleServerMessages = useCallback(
    ...
    [handleGetLongestChainRequest, handleNewBlockAnnouncement, handleNewBlockRequest]
  );
  ...
  return (
    <main>
      ...
      <section>
        <TransactionForm onAddTransaction={addTransaction} disabled={node.isMining || node.chainIsEmpty} />
      </section>
      <section>
